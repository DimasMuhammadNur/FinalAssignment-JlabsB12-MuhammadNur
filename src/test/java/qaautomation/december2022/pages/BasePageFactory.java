...
public class BasePageFactory {
	//BasePageFactory merupakan class untuk setting action apa yang mau kita gunakan
	//Action yang digunakan pada saat login dan ketika di profile yaitu setText, Click, dan getText
